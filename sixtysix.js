...
(function() {
  ...
  ComputerAI = (function() {
    ...
    ComputerAI.prototype.bestLead = function() {
      var card, certainWinners, likelyPoints, marriageCards, nontrumpOptions, options, topTrumps, toppers, trumpMarriageCards;
      ...
      if (certainWinners.length > 0 && this.aggressive) {
