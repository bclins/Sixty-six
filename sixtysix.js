...
(function() {
  ...
  ComputerAI = (function() {
    ...
    ComputerAI.prototype.bestLead = function() {
      var card, certainWinners, likelyPoints, marriageCards, nontrumpOptions, options, topTrumps, toppers, trumpCards;
      ...
      if (certainWinners.length > 0 && game.deckClosed) {
        ...
        if (trumpCards.length > 0) {
          return trumpCards[0].computerPlay();
        } else {
    ...
    ComputerAI.prototype.bestFollow = function() {
      var card, legalOptions, options, playersCard, winningOptions, worthwhileOptions;
      options = computer.getCards();
      ...
      worthwhileOptions = (function() {
        var _i, _len, _results;
        _results = [];
        for (_i = 0, _len = winningOptions.length; _i < _len; _i++) {
          card = winningOptions[_i];
          if (this.netValue(card, playersCard) > 0) {
            _results.push(card);
          }
        }
        return _results;
      ...
      if (this.aggressive && winningOptions.length > 0) {
        ...
        if (worthwhileOptions.length > 0) {
          return this.bestValue(worthwhileOptions, playersCard).computerPlay();
        } else {
          return this.worstCard(legalOptions).computerPlay();
        }
      }
    };
    ...
    Card.prototype.playCard = function() {
      ...
      if (playerCard.isEmpty()) {
        ...
        if (game.playerLeads || isLegal(computerCard.select(), this, hand)) {
          ...
          return alert("Now that the stack is closed, you must follow suit! If you can't follow suit, you must trump if you can.");
        }
      }
    };
  ...
  Game = (function() {
    ...
    Game.prototype.score = function() {
      ...
      return document.getElementById("scorebar").innerHTML = "<p>You: " + this.playerPoints + " points. " + this.playerMarriages + " &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; Trump: " + suitString[this.trumpSuit] + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Computer: " + this.computerPoints + " points. " + this.computerMarriages;
    };
  ...
  isLegal = function(cardLed, card2, hand2) {
    ...
    return (!game.deckClosed) || (cardLed.suit === card2.suit) || ((_ref = cardLed.suit, __indexOf.call(suits2, _ref) < 0) && (card2.isTrump() || (_ref1 = game.trumpSuit, __indexOf.call(suits2, _ref1) < 0)));
  };
